                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <a class="btn btn-primary" href="{{ route('songs.create')}}" style="margin-bottom:20px">Create Song</a>
                                    ...
                                    <table class="table">
                                        <thead class="bg-light">
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0">Song Name</th>
                                                <th class="border-0">Singers</th>
