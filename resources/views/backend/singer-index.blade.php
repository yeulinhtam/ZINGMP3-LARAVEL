                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">
                                <a class="btn btn-primary" href="{{ route('singers.create') }}" style="margin-bottom: 20px">Create Singer</a>
                                    ...
                                    <table class="table">
                                        <thead class="bg-light">
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0">Singer Name</th>
                                        ...
                                        <tbody>
                                            @foreach ($data as $key => $value )
                                                <tr>
                                                    ...
                                                    <td>{{ $value->name_singer }}</td>
                                                    <td>
                                                        <img src="../storage/app/{{ $value->image_singer }}"
                                                         style="width: 60px; height: 60px; border-radius: 50%">
                                                    </td>
                                                    <td>
                                                        @if($value->status_singer == 1)
